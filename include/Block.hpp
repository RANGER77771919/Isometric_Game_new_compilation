...
namespace BlockConfig {
    ...
    constexpr int CHUNK_SIZE = 8;    ///< Tamaño del chunk en bloques (8x8x256 bloques)
    constexpr int WORLD_HEIGHT = 256; ///< Altura máxima del mundo en bloques (de Y=0 a Y=255)
     ...
     * - 8 * 8 * 256 = 16,384 bloques
     * - 16,384 bytes (~16 KB) por chunk
     *
     * Con LOAD_RADIUS = 4 (9x9 = 81 chunks en memoria):
     * - 81 chunks * 16 KB = ~1.3 MB
     *
     * Esto hace factible mantener muchos chunks en memoria simultáneamente.
     */
}

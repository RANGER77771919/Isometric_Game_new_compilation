...
/**
 * @class Chunk
 * @brief Sección del mundo de 8x8x256 bloques
 *
 * Un Chunk es una sección vertical del mundo que contiene:
 * - CHUNK_SIZE x CHUNK_SIZE = 8x8 bloques en horizontal
 * - WORLD_HEIGHT = 256 bloques en vertical
 * - Total: 8 * 8 * 256 = 16,384 bloques (~16 KB de memoria)
 *
 * Características:
 ...
 * - Los bloques se almacenan en un vector 1D (array lineal)
...
public:
     ...
     * - Todos los bloques inicializados como AIRE
     * - Estado "no generado" (m_generated = false)
     * - Memoria reservada para 16,384 bloques
     */
...
private:
    ...
    // Solo almacenar bloques sólidos en lugar de todos los 16,384 bloques

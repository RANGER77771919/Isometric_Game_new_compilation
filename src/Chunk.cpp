 ...
 *
 * OPTIMIZACIÓN 8: SPARSE DATA STRUCTURES
 * - Ya no reserva 16,384 bloques (solo los sólidos)
 * - Memoria inicial: 0 bloques
 * - Memoria típica: ~5,000 bloques (~70% menos que denso)
 *
...
Chunk::Chunk(ChunkPos position)
    ...
    , m_generated(false)
{
    // OPTIMIZACIÓN 8: No reservar memoria upfront
    // Los bloques se agregan solo cuando son sólidos
    // Capacity inicial del unordered_map (optimización)
    m_blocks.reserve(5000);  // ~30% de 16,384 bloques son sólidos
}
 ...
 * @return Índice en el array m_blocks [0, 16383]
 *
 ...
 *
 * Layout de memoria (con CHUNK_SIZE=8):
 ...
 * - Índices 16320-16383: última fila Z=7, última capa Y=255
 *
